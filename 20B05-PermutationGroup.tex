...
\usepackage{pmmeta}
\pmcanonicalname{PermutationGroup}
\pmcreated{2013-03-22 13:16:34}
\pmmodified{2013-03-22 13:16:34}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{permutation group}
\pmrecord{5}{33758}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A {\em permutation group} is a pair $(G,X)$ where $G$ is an abstract group, and $X$ is a set on
