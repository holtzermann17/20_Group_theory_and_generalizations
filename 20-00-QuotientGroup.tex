...
\usepackage{pmmeta}
\pmcanonicalname{QuotientGroup}
\pmcreated{2013-03-22 12:04:06}
\pmmodified{2013-03-22 12:04:06}
\pmowner{azdbacks4234}{14155}
\pmmodifier{azdbacks4234}{14155}
\pmtitle{quotient group}
\pmrecord{35}{31127}
\pmprivacy{1}
...
\pmsynonym{factor group}{QuotientGroup}
\pmsynonym{quotient}{QuotientGroup}
%\pmkeywords{normal subgroup}
%\pmkeywords{subgroup}
%\pmkeywords{coset}
\pmrelated{Group}
...
\pmdefines{left congruence modulo a subgroup}
\pmdefines{right congruence modulo a subgroup}
\pmdefines{index}
