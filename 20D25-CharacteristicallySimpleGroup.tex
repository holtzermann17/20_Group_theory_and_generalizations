...
\usepackage{pmmeta}
\pmcanonicalname{CharacteristicallySimpleGroup}
\pmcreated{2013-03-22 13:16:58}
\pmmodified{2013-03-22 13:16:58}
\pmowner{mathcam}{2727}
\pmmodifier{mathcam}{2727}
\pmtitle{characteristically simple group}
\pmrecord{7}{33767}
\pmprivacy{1}
...
\pmsynonym{characteristically simple}{CharacteristicallySimpleGroup}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A group $G$ is called {\em characteristically simple} if its only 
characteristic subgroups are $\{1\}$ and $G$.  Any finite characteristically simple group is
the direct product of several copies of isomorphic simple groups.
%%%%%
%%%%%
\end{document}
