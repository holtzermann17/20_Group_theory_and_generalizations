...
\usepackage{pmmeta}
\pmcanonicalname{FrobeniusGroup}
\pmcreated{2013-03-22 13:16:30}
\pmmodified{2013-03-22 13:16:30}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Frobenius group}
\pmrecord{5}{33757}
\pmprivacy{1}
...
\pmdefines{Frobenius complement}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A permutation group $G$ on a set $X$ is {\em Frobenius} if no non-trivial element of $G$ fixes more than
one element of $X$.  Generally, one also makes the restriction that at least one non-trivial element
fix a point.  In this case the Frobenius group is called {\em non-regular}.

The stabilizer of any point in $X$ is called a {\em Frobenius complement}, and has the remarkable 
