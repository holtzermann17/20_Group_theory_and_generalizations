...
\usepackage{pmmeta}
\pmcanonicalname{pigroupsAndpigroups}
\pmcreated{2013-03-22 13:17:51}
\pmmodified{2013-03-22 13:17:51}
\pmowner{Algeboy}{12884}
\pmmodifier{Algeboy}{12884}
\pmtitle{$\pi$-groups and $\pi'$-groups}
\pmrecord{9}{33797}
\pmprivacy{1}
...
\textbf{Remark}.  If $G$ is finite, then $G$ is a $\pi$-group if every prime dividing $|G|$ is in $\pi$.
%%%%%
%%%%%
\end{document}
