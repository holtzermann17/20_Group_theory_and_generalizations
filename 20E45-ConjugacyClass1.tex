...
\usepackage{pmmeta}
\pmcanonicalname{ConjugacyClass1}
\pmcreated{2013-03-22 14:01:39}
\pmmodified{2013-03-22 14:01:39}
\pmowner{drini}{3}
\pmmodifier{drini}{3}
...
Since conjugation is an equivalence relation, we obtain a partition of $G$ into equivalence classes, called \emph{conjugacy classes}. So, the conjugacy class of $X$ (represented $C_x$ or $C(x)$ is given by
\[C_x=\{y\in X :y=gxg^{-1} \mbox{for some }g\in G\}\]
%%%%%
%%%%%
\end{document}
