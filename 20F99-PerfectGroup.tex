...
\usepackage{pmmeta}
\pmcanonicalname{PerfectGroup}
\pmcreated{2013-03-22 13:56:24}
\pmmodified{2013-03-22 13:56:24}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{perfect group}
\pmrecord{4}{34701}
\pmprivacy{1}
...
\pmsynonym{perfect}{PerfectGroup}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A group $G$ is called {\em perfect} if $G=[G,G]$, where $[G,G]$ is the derived subgroup of $G$, or equivalently, if the abelianization of $G$ is trivial.
%%%%%
%%%%%
\end{document}
