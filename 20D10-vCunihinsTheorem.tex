...
\usepackage{pmmeta}
\pmcanonicalname{vCunihinsTheorem}
\pmcreated{2013-03-22 13:17:54}
\pmmodified{2013-03-22 13:17:54}
\pmowner{mathcam}{2727}
\pmmodifier{mathcam}{2727}
\pmtitle{\v{C}unihin's theorem}
\pmrecord{11}{33798}
\pmprivacy{1}
...
\item
If $G$ is solvable, it is $\pi$-separable for all $\pi$, so such subgroups exist for all $\pi$.  This result is often called Hall's theorem.  There is another Hall's theorem, which is similar to this one, can be be found \PMlinkname{here}{HallsTheorem2}.
\end{enumerate}
