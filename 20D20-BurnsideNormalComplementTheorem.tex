...
\usepackage{pmmeta}
\pmcanonicalname{BurnsideNormalComplementTheorem}
\pmcreated{2013-03-22 13:16:22}
\pmmodified{2013-03-22 13:16:22}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Burnside normal complement theorem}
\pmrecord{5}{33754}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $G$ be a finite group, and $S$ a Sylow subgroup such that $C_G(S)=N_G(S)$.  Then $S$
has a normal complement.  That is, there exists a normal subgroup $N\lhd G$ such that 
$S\cap N=\{1\}$ and $SN=G$.
%%%%%
%%%%%
\end{document}
