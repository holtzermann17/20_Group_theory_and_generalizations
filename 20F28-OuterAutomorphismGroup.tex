...
\usepackage{pmmeta}
\pmcanonicalname{OuterAutomorphismGroup}
\pmcreated{2013-03-22 14:01:26}
\pmmodified{2013-03-22 14:01:26}
\pmowner{Thomas Heye}{1234}
\pmmodifier{Thomas Heye}{1234}
\pmtitle{outer automorphism group}
\pmrecord{13}{34993}
\pmprivacy{1}
...
%\pmkeywords{inner automorphism}
%\pmkeywords{outer automorphism}
\pmrelated{InnerAutomorphism}
\pmdefines{outer automorphism group}
...
%% \include{argawarga}
\begin{document}
The \emph{outer automorphism group} of a group is the \PMlinkname{quotient}{QuotientGroup} of its automorphism group by its inner automorphism group:
