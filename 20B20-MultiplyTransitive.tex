...
\usepackage{pmmeta}
\pmcanonicalname{MultiplyTransitive}
\pmcreated{2013-03-22 13:16:37}
\pmmodified{2013-03-22 13:16:37}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{multiply transitive}
\pmrecord{5}{33759}
\pmprivacy{1}
...
\pmsynonym{$n$-transitive}{MultiplyTransitive}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $G$ be a group, $X$ a set on which it acts.  Let $X^{(n)}$ be the set of order $n$-tuples
of distinct elements of $X$. This is a $G$-set by the diagonal action: 
...
standard action of $A_n$, the alternating group, is $(n-2)$-transitive.
%%%%%
%%%%%
\end{document}
