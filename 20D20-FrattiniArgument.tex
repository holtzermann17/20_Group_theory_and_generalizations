...
\usepackage{pmmeta}
\pmcanonicalname{FrattiniArgument}
\pmcreated{2013-03-22 13:16:02}
\pmmodified{2013-03-22 13:16:02}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Frattini argument}
\pmrecord{5}{33748}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
If $H$ is a finite normal subgroup of a group $G$, and $S$ is a Sylow subgroup of $H$, then
$G=HN_G(S)$, where $N_G(S)$ is the normalizer of $S$ in $G$.
%%%%%
%%%%%
\end{document}
