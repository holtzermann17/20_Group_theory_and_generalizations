...
\usepackage{pmmeta}
\pmcanonicalname{SubgroupsContainingTheNormalizersOfSylowSubgroupsNormalizeThemselves}
\pmcreated{2013-03-22 13:16:47}
\pmmodified{2013-03-22 13:16:47}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{subgroups containing the normalizers of Sylow subgroups normalize themselves}
\pmrecord{6}{33763}
\pmprivacy{1}
...
$N_G(S)\subset M$.  Then $M=N_G(M)$.

\begin{proof}
By order considerations, $S$ is a Sylow subgroup of $M$.  Since $M$ is normal in $N_G(M)$,
by the Frattini argument, $N_G(M)=N_G(S)M=M$.
\end{proof}
%%%%%
%%%%%
\end{document}
