...
\usepackage{pmmeta}
\pmcanonicalname{Extension}
\pmcreated{2013-03-22 13:51:10}
\pmmodified{2013-03-22 13:51:10}
\pmowner{bwebste}{988}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A short exact sequence $0\to A\to B\to C\to 0$ is sometimes called an extension of  $C$ by $A$.  This \PMlinkescapetext{term} is also applied to an object $B$ which fits into such an exact sequence.
%%%%%
%%%%%
\end{document}
