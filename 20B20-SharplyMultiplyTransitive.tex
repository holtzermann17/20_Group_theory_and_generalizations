...
\usepackage{pmmeta}
\pmcanonicalname{SharplyMultiplyTransitive}
\pmcreated{2013-03-22 13:16:39}
\pmmodified{2013-03-22 13:16:39}
\pmowner{mathcam}{2727}
\pmmodifier{mathcam}{2727}
\pmtitle{sharply multiply transitive}
\pmrecord{5}{33760}
\pmprivacy{1}
...
\pmsynonym{sharply $n$-transitive}{SharplyMultiplyTransitive}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $G$ be a group, and $X$ a set that $G$ acts on, and let $X^{(n)}$ be the set of ordered $n$-tuples of distinct elements of $X$.  Then the action of $G$ on $X$ is \emph{sharply $n$-transitive} if $G$ acts regularly on $X^{(n)}$.
%%%%%
%%%%%
\end{document}
