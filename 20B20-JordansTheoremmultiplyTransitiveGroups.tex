...
\usepackage{pmmeta}
\pmcanonicalname{JordansTheoremmultiplyTransitiveGroups}
\pmcreated{2013-03-22 13:16:42}
\pmmodified{2013-03-22 13:16:42}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Jordan's theorem (multiply transitive groups)}
\pmrecord{6}{33761}
\pmprivacy{1}
...
\begin{enumerate}
\item $G$ is similar to $S_n$ with the standard action or
\item $G$ is similar to $A_{n+2}$ with the standard action or
\item $n=4$ and $G$ is similar to $M_{11}$, the Mathieu group of degree $10$ or
\item $n=5$ and $G$ is similar to $M_{12}$, the Mathieu group of degree $11$.
\end{enumerate}
%%%%%
%%%%%
\end{document}
