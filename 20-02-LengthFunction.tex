...
\usepackage{pmmeta}
\pmcanonicalname{LengthFunction}
\pmcreated{2013-03-22 13:41:29}
\pmmodified{2013-03-22 13:41:29}
\pmowner{mhale}{572}
\pmmodifier{mhale}{572}
\pmtitle{length function}
\pmrecord{6}{34365}
\pmprivacy{1}
\pmauthor{mhale}{572}
\pmtype{Definition}
\pmcomment{trigger rebuild}
\pmclassification{msc}{20-02}
...
\begin{document}
Let $G$ be a group.
A \textbf{length function} on $G$ is a function $L\colon G \to \Rset^+$ satisfying:
\begin{eqnarray*}
L(e) & = & 0, \\
L(g) & = & L(g^{-1}), \quad\forall g \in G, \\
