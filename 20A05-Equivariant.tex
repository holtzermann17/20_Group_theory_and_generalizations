...
\usepackage{pmmeta}
\pmcanonicalname{Equivariant}
\pmcreated{2013-03-22 13:56:45}
\pmmodified{2013-03-22 13:56:45}
\pmowner{bwebste}{988}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $G$ be a group, and $X$ and $Y$ left (resp. right) homogeneous spaces of $G$.  Then a map $f:X\to Y$ is called {\em equivariant} if $g(f(x))=f(gx)$ (resp. $(f(x))g=f(xg)$) for all $g\in G$.
%%%%%
%%%%%
\end{document}
