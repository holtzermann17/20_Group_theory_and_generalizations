...
\usepackage{pmmeta}
\pmcanonicalname{ProofOfFrattiniArgument}
\pmcreated{2013-03-22 13:16:05}
\pmmodified{2013-03-22 13:16:05}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{proof of Frattini argument}
\pmrecord{4}{33749}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $g\in G$ be any element. Since $H$ is normal, $gSg^{-1}\subset H$.  
Since $S$ is a Sylow subgroup of $H$, $gSg^{-1}=hSh^{-1}$ for some $h\in H$, by Sylow's theorems.
Thus $n=h^{-1}g$ normalizes $S$, and so $g=hn$ for $h\in H$ and $n\in N_G(S)$.
%%%%%
%%%%%
\end{document}
